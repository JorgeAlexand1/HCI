...
namespace ProyectoAgiles.Infrastructure.Migrations
{
    ...
    [Migration("20250703212400_AddTimeConfigurationTable")]
    partial class AddTimeConfigurationTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ProyectoAgiles.Domain.Entities.ArchivosUtilizadosEscalafon", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<string>("EstadoAscenso")
                        .IsRequired()
                        .HasMaxLength(50)
                    ...
                    b.Property<int>("SolicitudEscalafonId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("SolicitudEscalafonId");

                    b.HasIndex("DocenteCedula", "TipoRecurso");

                    b.HasIndex("TipoRecurso", "RecursoId");

                    b.ToTable("ArchivosUtilizadosEscalafon");
                });
            ...
            modelBuilder.Entity("ProyectoAgiles.Domain.Entities.SolicitudEscalafon", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaEnvioConsejo")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("MotivoRechazoConsejo")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");
            ...
            modelBuilder.Entity("ProyectoAgiles.Domain.Entities.TimeConfiguration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ProyectoAgiles.Domain.Entities.ArchivosUtilizadosEscalafon", b =>
                {
                    b.HasOne("ProyectoAgiles.Domain.Entities.SolicitudEscalafon", "SolicitudEscalafon")
                        .WithMany()
                        .HasForeignKey("SolicitudEscalafonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("SolicitudEscalafon");
                });

...
public class Usuario : BaseEntity
{
    ...
    // Propiedades SPOC (Single Point of Contact)
    public bool IsSPOC { get; set; } = false;
    public bool IsAvailable { get; set; } = true;
    public int CargaTrabajoActual { get; set; } = 0;
    
    // Nivel de soporte para escalación ITIL
    public NivelSoporte? NivelSoporte { get; set; }

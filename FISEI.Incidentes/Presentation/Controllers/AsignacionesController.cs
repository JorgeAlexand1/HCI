...
namespace FISEI.Incidentes.Presentation.Controllers
{
    ...
    public class AsignacionesController : ControllerBase
    {
        ...
        /// <summary>
        /// Obtiene la asignaci�n activa de un incidente
        /// </summary>
        ...
        public async Task<ActionResult<Asignacion>> GetAsignacionPorIncidente(int idIncidente)
        {
            ...
            if (asignacion == null)
                return NotFound(new { message = "No hay asignaci�n activa para este incidente" });

            return Ok(asignacion);
        }

        /// <summary>
        /// Obtiene asignaciones de un t�cnico
        /// </summary>
        ...
        /// <summary>
        /// Asigna autom�ticamente un incidente (distribuci�n equitativa)
        /// </summary>
        ...
        /// <summary>
        /// Permite a un t�cnico tomar un incidente sin asignar
        /// </summary>
        ...
        /// <summary>
        /// Reasigna un incidente a otro t�cnico
        /// </summary>
        [HttpPut("reasignar")]
